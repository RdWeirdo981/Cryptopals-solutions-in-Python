...
compare_str = "SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t"
boolean_compare = compare_str == str_to_byte
print("Check the answer: ", boolean_compare)